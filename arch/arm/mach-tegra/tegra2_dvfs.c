...
static struct dvfs dvfs_init[] = {
	...
	CPU_DVFS("cpu", 1, 0, MHZ, 216, 314, 456, 456, 503,  608,  760,  817,  912,  1000, 1200, 1400, 1504, 1600, 1640),
	CPU_DVFS("cpu", 1, 1, MHZ, 216, 314, 456, 456, 503,  608,  760,  817,  912,  1000, 1200, 1400, 1504, 1600, 1640),
	CPU_DVFS("cpu", 1, 2, MHZ, 608, 760, 760, 817, 912,  1000, 1200, 1400, 1504, 1600, 1640),
	CPU_DVFS("cpu", 1, 3, MHZ, 760, 817, 817, 912, 1000, 1200, 1400, 1504, 1600, 1640),
#else
