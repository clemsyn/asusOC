...
static struct dvfs dvfs_init[] = {
	...
	CPU_DVFS("cpu", 1, 0, MHZ, 216, 314, 456, 456, 503,  608,  760,  817,  912,  1000, 1200, 1400, 1504, 1600, 1646),
	CPU_DVFS("cpu", 1, 1, MHZ, 216, 314, 456, 456, 503,  608,  760,  817,  912,  1000, 1200, 1400, 1504, 1600, 1646),
	CPU_DVFS("cpu", 1, 2, MHZ, 598, 750, 750, 893, 893,  1000, 1200, 1400, 1504, 1600, 1646),
	CPU_DVFS("cpu", 1, 3, MHZ, 730, 845, 845, 940, 1000, 1200, 1400, 1504, 1600, 1646),
#else
	...
	CORE_DVFS("2d",      -1, 1, KHZ, 133000, 171000, 247000, 300000, 300000, 361000, 400000),

	CORE_DVFS("3d",       0, 1, KHZ, 114000, 161500, 247000, 304000, 304000, 333500, 333500),
	CORE_DVFS("3d",       1, 1, KHZ, 161500, 209000, 285000, 333500, 333500, 361000, 425000),
	CORE_DVFS("3d",       2, 1, KHZ, 218500, 256500, 323000, 380000, 380000, 400000, 425000),
	CORE_DVFS("3d",       3, 1, KHZ, 247000, 285000, 351500, 400000, 400000, 400000, 425000),
